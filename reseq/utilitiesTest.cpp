...
TEST(utilitiesTest, DominantBase) {
    ...
    test2.Update(at(seq, length(seq) - 1), seq,
                 length(seq) - 1); // Should run without crashing, output doesn't matter as it won't be used
    ...
    test2.Update(at(seq2, length(seq2) - 1), seq2,
                 length(seq2) - 1); // Should run without crashing, output doesn't matter as it won't be used
...
TEST(utilitiesTest, Divide) {
    ...
    EXPECT_EQ(1, Divide(17438564308265206, 17438564308265206))
        << "'Divide' function from utilities does not return proper 1\n";
...
TEST(utilitiesTest, Percent) {
    ...
    EXPECT_EQ(100, Percent(17438564308265206, 17438564308265206))
        << "'Percent' function from utilities does not return proper 100\n";
    ...
    EXPECT_EQ(50, SafePercent(734, 0))
        << "'SafePercent' function from utilities does not catch the zero denominator case properly\n";
}

TEST(utilitiesTest, MeanWithRoundingToFirst) {
    EXPECT_EQ(2, MeanWithRoundingToFirst(2, 2))
        << "'MeanWithRoundingToFirst' function from utilities does not return proper value without rounding\n";
    EXPECT_EQ(3, MeanWithRoundingToFirst(3, 2))
        << "'MeanWithRoundingToFirst' function from utilities does not round up properly\n";
    EXPECT_EQ(2, MeanWithRoundingToFirst(2, 3))
        << "'MeanWithRoundingToFirst' function from utilities does not round down properly\n";
}
