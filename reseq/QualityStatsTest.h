...
class QualityStatsTest : public BasicTestClass {
  protected:
    ...
    template <typename T>
    static void TestSizeAtIndex_0_1_98_99(const Vect<T>& vector, size_t size0, size_t size1, size_t size98,
                                          size_t size99, const char* context, const char* err_msg) {
    ...
    static void TestValueAtIndex_0_1_98_99(const Vect<T>& vector, U val0, U val1, U val98, U val99, const char* context,
                                           const char* err_msg) {
    ...
    template <typename U>
    static void TestRoundedValueAtIndex_0_1_98_99(const Vect<double>& vector, U val0, U val1, U val98, U val99,
                                                  const char* context, const char* err_msg) {
